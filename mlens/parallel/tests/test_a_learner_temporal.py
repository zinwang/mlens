...
def test_predict():
    ...
    args = get_learner(
        "predict", "temporal", False, False, window=4, step_size=4
    )
    run_learner(*args)
...
def test_transform():
    ...
    args = get_learner(
        "transform", "temporal", False, False, window=4, step_size=4
    )
    run_learner(*args)
...
def test_predict_prep():
    ...
    args = get_learner(
        "predict", "temporal", False, True, window=4, step_size=4
    )
    run_learner(*args)
...
def test_transform_prep():
    ...
    args = get_learner(
        "transform", "temporal", False, True, window=4, step_size=4
    )
    run_learner(*args)
...
def test_predict_proba():
    ...
    args = get_learner(
        "predict", "temporal", True, False, window=4, step_size=4
    )
    run_learner(*args)
...
def test_transform_proba():
    ...
    args = get_learner(
        "transform", "temporal", True, False, window=4, step_size=4
    )
    run_learner(*args)
...
def test_predict_prep_proba():
    """[Parallel | Learner | Temporal | Proba | No Prep] test predict"""
    args = get_learner(
        "predict", "temporal", True, True, window=4, step_size=4
    )
    run_learner(*args)
...
def test_transform_prep_proba():
    ...
    args = get_learner(
        "transform", "temporal", True, True, window=4, step_size=4
    )
    run_learner(*args)
