...
def test_fit():
    ...
    args = get_layer(
        "fit", "manual", "temporal", False, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict():
    ...
    args = get_layer(
        "predict", "manual", "temporal", False, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_transform():
    ...
    args = get_layer(
        "transform", "manual", "temporal", False, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_fit_prep():
    ...
    args = get_layer(
        "fit", "manual", "temporal", False, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict_prep():
    ...
    args = get_layer(
        "predict", "manual", "temporal", False, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_transform_prep():
    ...
    args = get_layer(
        "transform", "manual", "temporal", False, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_fit_proba():
    ...
    args = get_layer(
        "fit", "manual", "temporal", True, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict_proba():
    ...
    args = get_layer(
        "predict", "manual", "temporal", True, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_transform_proba():
    ...
    args = get_layer(
        "transform", "manual", "temporal", True, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_fit_prep_proba():
    ...
    args = get_layer(
        "fit", "manual", "temporal", True, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict_prep_proba():
    """[Parallel | Layer | Manual | Temporal | Proba | No Prep] test predict"""
    args = get_layer(
        "predict", "manual", "temporal", True, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_transform_prep_proba():
    ...
    args = get_layer(
        "transform", "manual", "temporal", True, True, window=2, step_size=3
    )
    run_layer(*args)
