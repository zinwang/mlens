...
def test_fit_fp():
    ...
    args = get_layer(
        "fit", "multiprocessing", "blend", False, False, feature_prop=2
    )
    run_layer(*args)
...
def test_predict_fp():
    ...
    args = get_layer(
        "predict", "multiprocessing", "blend", False, False, feature_prop=2
    )
    run_layer(*args)
...
def test_transform_fp():
    ...
    args = get_layer(
        "transform", "multiprocessing", "blend", False, False, feature_prop=2
    )
    run_layer(*args)
