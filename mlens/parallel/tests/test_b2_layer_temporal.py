...
def test_fit():
    ...
    args = get_layer(
        "fit", "threading", "temporal", False, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict():
    ...
    args = get_layer(
        "predict", "threading", "temporal", False, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_fit_prep():
    ...
    args = get_layer(
        "fit", "threading", "temporal", False, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict_prep():
    ...
    args = get_layer(
        "predict", "threading", "temporal", False, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_fit_proba():
    ...
    args = get_layer(
        "fit", "threading", "temporal", True, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict_proba():
    ...
    args = get_layer(
        "predict", "threading", "temporal", True, False, window=2, step_size=3
    )
    run_layer(*args)
...
def test_fit_prep_proba():
    ...
    args = get_layer(
        "fit", "threading", "temporal", True, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_predict_prep_proba():
    """[Parallel | Layer | Threading | Temporal | Proba | No Prep] test predict"""
    args = get_layer(
        "predict", "threading", "temporal", True, True, window=2, step_size=3
    )
    run_layer(*args)
...
def test_transform_prep_proba():
    ...
    args = get_layer(
        "transform", "threading", "temporal", True, True, window=2, step_size=3
    )
    run_layer(*args)
